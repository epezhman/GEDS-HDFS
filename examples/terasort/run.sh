...
#  --conf spark.hadoop.fs.geds.metadataserver="geds-serv-tera:50005"
  --conf spark.hadoop.fs.geds.metadataserver="geds-mds-go-ter:50004"
  --conf spark.hadoop.fs.geds.pub_sub_enabled="true"
